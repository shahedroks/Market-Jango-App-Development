...
class DriverNotificatons extends StatefulWidget {
  const DriverNotificatons({super.key});
  static final routeName ='/driverNotifications'; 

  @override
  State<DriverNotificatons> createState() => _DriverNotificatonsState();
}

class _DriverNotificatonsState extends State<DriverNotificatons> {
  @override
