...
//
//   static const String routeName = '/transort_message';
//
//   @override
//   State<TransportMessage> createState() => _TransportChartState();
// }
//
// class _TransportChartState extends State<TransportMessage> {
...
//         0,
//         ChatMessage(
//           // Ensure ChatMessage constructor matches
//           text: text,
//           isSender: true,
...
//           children: [
//             CircleAvatar(
//               // Consider making radius responsive if needed: radius: 20.r
...
//   CrossAxisAlignment messageAlignment = message.isSender
...
//                 ? 0
//                 : (message.isOrderSummary ? 16.w : 16.w), // Use .w
...
//           ),
//           SizedBox(width: 8.w), // Use .w
//           Flexible(child: CustomTextFromField(hintText: "Type a message...")),
//           SizedBox(width: 8.w), // Use .w
//           Container(
//             // Consider making size responsive: padding: EdgeInsets.all(8.r)
//             decoration: BoxDecoration(
...
//         ? AllColor.blue.withOpacity(
//             0.2,
//           ) // Adjusted to a similar color from AllColor
