...
class TransportNotifications extends StatefulWidget {
  const TransportNotifications({super.key});

   static const String routeName = '/transport_notificatons';

  @override
  State<TransportNotifications> createState() => _TransportNotificationsState();
}

class _TransportNotificationsState extends State<TransportNotifications> {
  @override
