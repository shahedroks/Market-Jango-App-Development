...
class _VendorCancelledScreenState extends State<VendorCancelledScreen> {
  ...
  // 0 = Pending, 1 = Completed, 2 = Cancelled (default)
  int _tab = 2;
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(20),
              border: Border.all(color: active ? AllColor.loginButtomColor : AllColor.grey200),
              boxShadow: active ? [BoxShadow(color: Colors.black12, blurRadius: 6, offset: Offset(0, 2))] : null,
            ),
            child: Text(
              text,
              style: TextStyle(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: selected ? AllColor.loginButtomColor : AllColor.grey200),
        ),
        child: Text(
          text,
          style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 6),
          Text('Order placed on ${data.date}', style: TextStyle(color: AllColor.black54, fontSize: 12)),
        ],
      ),
    );
  }
